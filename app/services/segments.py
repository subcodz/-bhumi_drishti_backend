...
def get_road_segments(
    ...
    try:
        ...
        for idx, (segment, geojson_str, risk, feat) in enumerate(results):
            if feat and clf:
                vectors.append([
                    float(feat.elevation_m or 0.0),
                    float(feat.slope_deg or 0.0),
                    float(feat.terrain_roughness or 0.0),
                    float(feat.distance_to_river_m or 0.0),
                    float(feat.distance_to_stream_m or 0.0),
                    1.0 if feat.within_flood_zone else 0.0,
                    float(feat.rainfall_1h_mm or 0.0),
                    float(feat.rainfall_6h_mm or 0.0),
                    float(feat.rainfall_24h_mm or 0.0),
                    float(feat.rainfall_72h_mm or 0.0),
                    float(feat.flood_events_1y or 0.0),
                    float(feat.landslide_events_1y or 0.0),
                    float(feat.blockages_1y or 0.0),
                    float(feat.road_damage_reports_30d or 0.0),
                    1.0 if feat.construction_active else 0.0,
                    float(feat.congestion_ratio or 0.0),
                    float(feat.flood_reports_24h or 0.0),
                    float(feat.landslide_reports_24h or 0.0),
                    float(segment.length_m or 500.0),
        ...
        print(f"Warning: Batch ML prediction fallback: {e}")
